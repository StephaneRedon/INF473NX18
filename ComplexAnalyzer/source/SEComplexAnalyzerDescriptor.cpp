/// \headerfile SEComplexAnalyzerAppDescriptor.hpp "SEComplexAnalyzerAppDescriptor.hpp"
#include "SEComplexAnalyzerAppDescriptor.hpp"
...
SB_ELEMENT_DESCRIPTION("This SAMSON Element analyzes databases of proteins");
SB_ELEMENT_DOCUMENTATION("Resource/Documentation/doc.html");
SB_ELEMENT_VERSION_NUMBER("0.11.0");

SB_ELEMENT_CLASSES_BEGIN;

	SB_ELEMENT_CLASS(SEComplexAnalyzerApp);
